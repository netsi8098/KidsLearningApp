...
export interface VideoItem {
   ...
   *
   * Only ever set on YouTube entries. Locally generated episodes are served
   * from our own /public/videos, so their ids cannot go dead.
   */
  unavailable?: true;
}
 ...
 *
 * Prefer `playableVideos` for anything a child sees — this list still contains
 * entries flagged `unavailable`.
 */
